...
import { FaDragon, FaYinYang } from "react-icons/fa";
  ...
  return (
    <div className="h-screen bg-cover bg-center flex items-center justify-center relative" style={{ backgroundImage: 'url(/path/to/your/oriental-background.jpg)' }}>
      ...
      <div className="bg-gray-900 bg-opacity-80 p-12 rounded-2xl shadow-2xl border border-gray-700 relative z-20 transform transition duration-700 hover:scale-105 hover:bg-opacity-90">
        <h1 className="text-4xl font-extrabold text-center text-red-600 mb-8 tracking-widest drop-shadow-lg flex items-center justify-center">
          <FaDragon className="inline-block mr-3 animate-pulse" /> Login
        </h1>
        <input
          type="text"
          ...
          className="w-full p-4 mb-6 border-none rounded-lg text-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-red-600 shadow-inner"
        />
        <input
          type="password"
          ...
          className="w-full p-4 mb-8 border-none rounded-lg text-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-red-600 shadow-inner"
        />
        <button
        ...
        >
          <FaYinYang className="mr-2 animate-spin-slow" /> Enter the Temple
        </button>
      </div>
    </div>
  );
